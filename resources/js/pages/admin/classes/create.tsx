...
export default function CreateClass({ academicYears, teachers, subjects }: CreateClassProps) {
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.class_teacher_id.toString()} onValueChange={(value) => setData('class_teacher_id', parseInt(value))}>
                                        <SelectTrigger>
